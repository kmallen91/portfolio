    ...
    return (
        <div className='about-container'>
            <div className='about-section'>
                ...
                Javascript with an emphasis in React. I am proficient with Cloud technologies and have an AWS Certification as a Certified Cloud Practitioner. Also proficient in Node/Express as 
